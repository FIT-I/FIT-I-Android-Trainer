...
class ProfileModifyCostActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState:Bundle?){
        ...
        Log.d("post cost", ModifyTrainerInfoRequest(costHour,intro,name,serviceDetail).toString())
        var modiCost : String? =""
        ...
        buttonDone.setOnClickListener{
            ...
            trainerService.modifyTrainerInfo(
                ModifyTrainerInfoRequest(modiCost,intro,
                    name,serviceDetail))
                .enqueue(object :
                    ...
                    override fun onResponse(
                        ...
                        if (response.isSuccessful) {
                            ...
                            Log.d("post", "onResponse 실패"+  ModifyTrainerInfoRequest(modiCost,intro,
                                name,serviceDetail))
                        }
                    }
        ...
        fun onCheckChange(compoundButton: CompoundButton){
